...
<div class="reserve">
    ...
    <div class="lsItem">
        ...
        <span id="dayCount" name="jumlah-hari" class="ff-22"></span>
    </div>
    <div class="lsItem">
...
$(function () {
    ...
    dateRangePicker.on('apply.daterangepicker', function (ev, picker) {
        ...
        if (daysDiff > limitedDate) {
            alert('Please select a date range of up to ' + limitedDate + ' days.');
            dateRangePicker.val(''); // Clear the input field if the selection is invalid
            dayCount.text(''); // Clear the day count
        } else {
            ...
            dayCount.text(` (${daysDiff} days)`); // Display the count in parentheses
        }
    });
