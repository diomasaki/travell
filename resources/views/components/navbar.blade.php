...
<body>
    <div class="container-nav">
        <div class="wrapper-nav">
            ...
            <div class="right-nav"><div class="menuItem-nav"><a href="{{ route('home') }}" style="text-decoration: none; color: white;">Beranda</a></div><div class="menuItem-nav">Destinasi</div><div class="menuItem-nav">Buat Trip</div><div class="menuItem-nav-i"><i class="fa fa-user" aria-hidden="true" style="color: white;"></i></div><div class="menuItem-nav"><div class="search-container"><input type="text" class="search"><i class="fa fa-search" aria-hidden="true" style="color: white;"></i></div></div><div class="menuItem-nav-i">
