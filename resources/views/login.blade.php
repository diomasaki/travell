            ...
            <div class="login-form-container">
                ...
                <div class="form">
                    ...
                    <form action="/login/proses" method="POST" class="lf">
                        ...
                        <div class="form-input">
                            <input for="email" name="email" value="{{ Session::get('email') }}"  type="email" class="login-input" placeholder="E-mail">
                        </div>
                        <div class="form-input">
                            <input for="password" name="password" value="{{ Session::get('password') }}" type="password" class="login-input" placeholder="Password">
                        </div>
                        <div class="form-input">
                                <button name="submit" type="submit" class="login-submit">Masuk</button>
                        </div>
                    </form>
                </div>
                <div class="login-google-container">
                    ...
                    <div class="google-container-signin">
                        <img class="google" src="https://www.freepnglogos.com/uploads/google-logo-png/google-logo-png-webinar-optimizing-for-success-google-business-webinar-13.png" alt=""> <p class="google">Masuk dengan google</p>
                    </div>
                    </a>
                </div>
            </div>
